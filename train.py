...
def sigmoid(z):
    """
    This function computes sigmoid(z).
...
def model(X_train, Y_train, X_test, Y_test, num_iterations = 2000, learning_rate = 0.5, print_cost = True):
    ...
    """
    This function builds the logistic regression model by calling the function that was implemented previously.
